...
> (영어 본문 + 한국어 초록, 그림 4개). 제출용 LaTeX: `docs/paper.tex` + `docs/references.bib`
> (Overleaf에서 XeLaTeX로 컴파일).

> **최종 결과 — 코퍼스 100편, n=40, 동일 judge, coverage 1.0 (agent vs baseline_best):**
> - faithfulness     0.853 → **0.872**  (+0.019)
> - answer_relevancy 0.299 → **0.791**  (+0.493)
> - context_recall   0.208 → **0.879**  (+0.671)
> - context_precision 0.200 → **0.862**  (+0.662)
>
> agent route(n=40): vector 34 / local 5 / global 1.  스냅샷: `*_100p.json`(100편),
